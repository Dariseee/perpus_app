...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
    <h2 class="mb-4 text-xl font-bold text-black-900 dark:text-black">Tambah Anggota Baru</h2>
      <form action="proses-tambah.php" method="POST">
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              <div class="w-full">
                  <label for="nik" class="block mb-2 text-sm font-medium text-black-900 dark:text-black">NIK</label>
              ...
              <div class="w-full">
                  <label for="namalengkap" class="block mb-2 text-sm font-medium text-black-900 dark:text-black">Nama Lengkap</label>
              ...
              <div class="sm:col-span-2">
                  <label for="alamat" class="block mb-2 text-sm font-medium text-black-900 dark:text-black">Alamat</label>
              ...
              <div class="sm:col-span-2">
                  <label for="notelp" class="block mb-2 text-sm font-medium text-black-900 dark:text-black">Nomor Telepon</label>
